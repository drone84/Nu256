...
namespace Nu256.Simulator.MemoryLocations
{
    public static partial class MemoryMap
    {
        ...
        public const int SRAM_SIZE = 0x080000; // 1MB Static RAM (512K on prototype)
        ...
        public const int SYSTEM_SIZE = 0x1000000; // Total address space (used by simulator to allocate virtual memory)
